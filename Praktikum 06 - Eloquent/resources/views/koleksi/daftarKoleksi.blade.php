    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <a href="{{ route('koleksi.registerKoleksi') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md 
                ...
                focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150">Tambah Koleksi</a>
